...
import '../styles/Login.css'; // Import the new premium styles
...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setTimeout(() => {
                // Fire global toast
                window.dispatchEvent(new CustomEvent('add-toast', { detail: { message: `Welcome back, ${username}!`, type: 'success' } }));
                navigate('/');
        ...
        <div className="auth-page-container">
            ...
            <div className={`auth-card ${shake ? 'shake' : ''} ${success ? 'success-anim' : ''}`}>
                ...
                <div className="auth-footer">
                    ...
                    <Link to="/register" className="auth-link">Create yours now</Link>
                </div>
            </div>
        </div>
    );
